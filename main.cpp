...
int main()
{
    ...
    DecisionPoint start("You are standing outside a spooky house. Your friend Emmanuel and your rival Flitch are with you. Who do you follow?", {EmmanuelChosenPath, FlitchChosenEnding}, {"Follow Emmanuel", "Follow Flitch"}, 5);
    start.makeDecision();
